    ...
    <>
      <div className="App">
        ...
        <Navbar bg="dark" variant="dark" expand="lg">
          <Container>
            <Navbar.Brand href="#">Mon Projet React</Navbar.Brand>
        ...
        <Container className="mt-4">
          ...
          <p className="mt-3">Bonjour, {prenom ? prenom : "là !"}</p>

          {/* Avatar si prénom fourni */}
          {prenom && (
            <img
              src={avatarUrl}
              alt="Avatar"
